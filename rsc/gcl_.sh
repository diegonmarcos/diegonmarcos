...
#git clone https://github.com/diegonmarcos/dev.git
#git -C dev pull

# lecol42
#git clone git@github.com:diegonmarcos/lecole42.git
#git clone https://github.com/diegonmarcos/lecol42.git
#git -C lecole42 pull
...
#git clone https://github.com/diegonmarcos/front.git
#git -C front pull

# website
#git clone git@github.com:diegonmarcos/diegonmarcos.github.io.git website
#git clone https://github.com/diegonmarcos/diegonmarcos.github.io.
#git -C website pull